...
- Applied Machine Learning in Python and C++ for image recognition
- Used the Caffe framework to detect home appliances in e-commerce pages
- Extracted information from unstructured data (images and text) from e-commerce sites
...
| Year | Achievement |
|------|-------------|
| 2022 | Worked for CK-12 Foundation (USA)| 
...
Cinema · Travelling · Playing with the kids · Playing guitar
